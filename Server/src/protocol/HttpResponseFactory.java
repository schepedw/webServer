...
public class HttpResponseFactory {
	...
	/**
	 * Creates a {@link HttpResponse} object for sending a created response.
	 * 
	 * @param connection Supported values are {@link Protocol#OPEN} and {@link Protocol#CLOSE}.
	 * @return A {@link HttpResponse} object represent 201 status.
	 */
	public static HttpResponse create301PermanentlyMoved(String fileURL, String connection) {
		...
		// Lets fill up header fields with more information
		fillGeneralHeader(response, connection);
		// Add a location to redirect to the newly created resource
		response.put(Protocol.LOCATION, fileURL);
